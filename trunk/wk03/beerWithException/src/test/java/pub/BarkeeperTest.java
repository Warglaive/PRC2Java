...
public class BarkeeperTest {
    ...
    void over_order_returns_null() {
        ...
        assertThatThrownBy(suspectCode).isExactlyInstanceOf(EmptyStockException.class);
    }

//    @Test
//    void barkeeperTapsBeer() throws EmptyStockException {
//        //Double expected = PINT;
//        //Beer actual = barkeeper.tapBeer();
//        assertThat(actual.getSize()).isCloseTo(expected, within(0.1d));
//    }

//    @Test
//    void barkeeperServesDrinker() throws Exception {
...
//        assertThat(volumeLeft1).as("volumeleft did not decrease").isCloseTo(startVolume - PINT, within(.01));
//    }
}
